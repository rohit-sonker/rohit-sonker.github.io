...
* Rohit Sonker, Hiro Farre, Jiayu Chen, Andrew Rothstein, Ian Char, Ricardo Shousha, Egemen Kolemen, Jeff Schneider  
  ["Offline Reinforcement Learning for Rotation Profile Control in Tokamaks"](https://arxiv.org/abs/2605.05857).  
  *Learning for Dynamics & Control Conference (L4DC), 2026.*

* Tejus Gupta, Rohit Sonker, EM Karagözlü, Barnabás Póczos, Jeff Schneider  
  ["Large Language Model-based Bayesian Optimization for Tokamak Stabilization"](https://ml4physicalsciences.github.io/2025/files/NeurIPS_ML4PS_2025_268.pdf).  
  *Workshop on Machine Learning and Physical Sciences, NeurIPS 2025.*
